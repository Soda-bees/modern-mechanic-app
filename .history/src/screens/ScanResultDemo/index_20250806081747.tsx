        ...
        <View style={styles.lowerBody}>
          <ScrollView showsVerticalScrollIndicator={false}>
            {data?.map((scan, index) => (
              <View
                key={index}
                style={[{paddingBottom: sizes.screenHeight * 0.05}]}>
                <Text style={styles.titleLarge}>DTC Code: {scan?.code}</Text>
                ...
                <Text style={styles.textWhiteSmall}>{scan?.cost_estimate}</Text>
                <View style={styles.hr}></View>
                ...
                <Text style={styles.textWhiteSmall}>
                  Feel free to submit your complain or any issues regarding the
                  scan result.
                </Text>
