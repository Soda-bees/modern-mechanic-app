...
type RouteProps = RouteProp<RootStackParamList, 'Query'>;
        ...
        <ScrollView contentContainerStyle={{flexGrow: 1}}>
          <View style={styles.screen}>
            <View style={styles.lowerBody}>
              ...
              <Text style={styles.inputLabel}>Select Scans</Text>

              <CustomMultiSelectDropdown
                options={scanOptions}
                selected={selectedScanIds}
                onChange={setSelectedScanIds}
                placeholder="Select related scans"
              />
              ...
              <View style={styles.textArea}>
                <TextInput
                  multiline={true}
                  numberOfLines={6}
                  placeholder="Briefly describe the issues you're experiencing with your car so the workshop can be better prepared for your visit."
                  placeholderTextColor={colors.disabledText}
