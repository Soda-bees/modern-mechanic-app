          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.transmissionRow}>
              ...
              <TouchableOpacity
                ...
                <Image
                  source={
                    transmission === 'Manual' ? images.selected : images.select
                  }
                  style={styles.selectIcon}
                />
                <Text
            ...
            <View
              ...
              <Text style={styles.errMsg}>
                {errMsg}asdasdasd asd asd asda sdas da sd asd a sd as d as d
                asdasd asd asdasd asdasd asdasd asdasd asd as dasd asd asd{' '}
              </Text>
            </View>
          </View>
